...
// Legacy Bug type for backward compatibility
export type Bug = Issue;

// Legacy bug schema for backward compatibility
export const bugSchema = z.object({
  ...
  // Issue type - fixed as Bug for legacy compatibility
  type: z.literal("Bug"),

  // Priority level - impacts scheduling and resource allocation
  priority: z.enum(priorities).optional().default("Medium"),

  // Severity level - legacy field, maps to priority
